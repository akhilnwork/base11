  ...
  // Common class names
  const introTextClasses = "text-xl leading-9 font-poppins text-gray-600 opacity-90 mb-12";
  const sectionTitleClasses = "text-2xl font-geometr415-lt-bt text-black mb-4";
  const sectionTextClasses = "text-base leading-7 font-poppins text-gray-600 mb-8";
const LegalPages = ({data}) => {
    const {title, description , content} = data;
  return (
    <>
    <main className="innrPage pt-20 mt-20">
